...
class SparkConfig:
    ...
    def from_env(cls) -> 'SparkConfig':
        ...
        return cls(
            ...
            shuffle_partitions=int(os.environ.get('SPARK_SHUFFLE_PARTITIONS', cls.shuffle_partitions)),
            default_parallelism=int(os.environ.get('SPARK_DEFAULT_PARALLELISM', cls.default_parallelism)),
        )
